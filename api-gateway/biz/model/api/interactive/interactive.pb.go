...
// 	protoc        v3.21.12
// source: idl/gateway/interactive.proto
...
func (x *FavoriteActionRequest) Reset() {
	*x = FavoriteActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[0]
...
func (*FavoriteActionRequest) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{0}
}
...
func (x *FavoriteActionResponse) Reset() {
	*x = FavoriteActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FavoriteActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{1}
}
...
func (x *FavoriteListRequest) Reset() {
	*x = FavoriteListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FavoriteListRequest) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{2}
}
...
func (x *FavoriteListResponse) Reset() {
	*x = FavoriteListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*FavoriteListResponse) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{3}
}
...
func (x *CommentActionRequest) Reset() {
	*x = CommentActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CommentActionRequest) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{4}
}
...
func (x *CommentActionResponse) Reset() {
	*x = CommentActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CommentActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{5}
}
...
func (x *CommentListRequest) Reset() {
	*x = CommentListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CommentListRequest) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{6}
}
...
func (x *CommentListResponse) Reset() {
	*x = CommentListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_gateway_interactive_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CommentListResponse) Descriptor() ([]byte, []int) {
	return file_idl_gateway_interactive_proto_rawDescGZIP(), []int{7}
}
...
var File_idl_gateway_interactive_proto protoreflect.FileDescriptor

var file_idl_gateway_interactive_proto_rawDesc = []byte{
	0x0a, 0x1d, 0x69, 0x64, 0x6c, 0x2f, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x69, 0x6e,
	0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x07, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x1a, 0x17, 0x69, 0x64, 0x6c, 0x2f, 0x67, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0x69, 0x0a, 0x15, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x41, 0x63, 0x74,
	...
	0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x2d, 0x0a, 0x0a, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x6c,
	0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x67, 0x61, 0x74, 0x65,
	0x77, 0x61, 0x79, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x52, 0x09, 0x76, 0x69, 0x64, 0x65, 0x6f,
	0x4c, 0x69, 0x73, 0x74, 0x22, 0xaa, 0x01, 0x0a, 0x14, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x07,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x45, 0x0a, 0x12, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x14, 0x0a,
	0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f,
	0x6b, 0x65, 0x6e, 0x12, 0x19, 0x0a, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x8a,
	...
	0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x67,
	0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x52, 0x0b,
	0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x40, 0x5a, 0x3e, 0x67,
	...
	0x77, 0x61, 0x79, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x62, 0x06, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_idl_gateway_interactive_proto_rawDescOnce sync.Once
	file_idl_gateway_interactive_proto_rawDescData = file_idl_gateway_interactive_proto_rawDesc
)

func file_idl_gateway_interactive_proto_rawDescGZIP() []byte {
	file_idl_gateway_interactive_proto_rawDescOnce.Do(func() {
		file_idl_gateway_interactive_proto_rawDescData = protoimpl.X.CompressGZIP(file_idl_gateway_interactive_proto_rawDescData)
	})
	return file_idl_gateway_interactive_proto_rawDescData
}

var file_idl_gateway_interactive_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_idl_gateway_interactive_proto_goTypes = []interface{}{
	(*FavoriteActionRequest)(nil),  // 0: gateway.FavoriteActionRequest
	(*FavoriteActionResponse)(nil), // 1: gateway.FavoriteActionResponse
	(*FavoriteListRequest)(nil),    // 2: gateway.FavoriteListRequest
	(*FavoriteListResponse)(nil),   // 3: gateway.FavoriteListResponse
	(*CommentActionRequest)(nil),   // 4: gateway.CommentActionRequest
	(*CommentActionResponse)(nil),  // 5: gateway.CommentActionResponse
	(*CommentListRequest)(nil),     // 6: gateway.CommentListRequest
	(*CommentListResponse)(nil),    // 7: gateway.CommentListResponse
	(*model.Video)(nil),            // 8: gateway.Video
	(*model.Comment)(nil),          // 9: gateway.Comment
}
var file_idl_gateway_interactive_proto_depIdxs = []int32{
	8, // 0: gateway.FavoriteListResponse.video_list:type_name -> gateway.Video
	9, // 1: gateway.CommentActionResponse.comment:type_name -> gateway.Comment
	9, // 2: gateway.CommentListResponse.comment_list:type_name -> gateway.Comment
...
func init() { file_idl_gateway_interactive_proto_init() }
func file_idl_gateway_interactive_proto_init() {
	if File_idl_gateway_interactive_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_idl_gateway_interactive_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_gateway_interactive_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_idl_gateway_interactive_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_idl_gateway_interactive_proto_goTypes,
		DependencyIndexes: file_idl_gateway_interactive_proto_depIdxs,
		MessageInfos:      file_idl_gateway_interactive_proto_msgTypes,
	}.Build()
	File_idl_gateway_interactive_proto = out.File
	file_idl_gateway_interactive_proto_rawDesc = nil
	file_idl_gateway_interactive_proto_goTypes = nil
	file_idl_gateway_interactive_proto_depIdxs = nil
}
