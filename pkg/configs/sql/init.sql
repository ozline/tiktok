...
(
    ...
    play_url        text      default 0                 not null comment 'play URL',
    cover_url       text      default 0                 not null comment 'cover URL',
    created_at      timestamp default current_timestamp not null comment 'create time',
    updated_at      timestamp default current_timestamp not null on update current_timestamp comment 'update profile time',
...
create table comment
{
    ...
    content             text        default 0                   not null comment 'comment content',
...
create table message
{
    ...
    content             text       default 0                   not null comment 'message content',
